...
extern void build_sload_map_test(Seq_T instructions);
extern void build_loadp_test(Seq_T instructions);
extern void build_unmap_test(Seq_T instructions);
extern void build_cond_test(Seq_T instructions);
...
static struct test_info {
        ...
        { "mult", NULL, "", build_mult_test},
        { "div", NULL, "", build_div_test},
        { "map", NULL, "", build_map_test},
        { "sload-map", NULL, "", build_sload_map_test},
        { "loadp", NULL, "", build_loadp_test},
        { "unmap", NULL, "", build_unmap_test},
        { "cond", NULL, "", build_cond_test},
        { "nand", NULL, "", build_nand_test},
        { "io", NULL, "", build_io_test},
